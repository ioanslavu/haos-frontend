...
export const UploadAssetDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[600px] bg-white/95 backdrop-blur-md border border-gray-200/50 shadow-xl">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold">Upload Marketing Asset</DialogTitle>
          <DialogDescription>
