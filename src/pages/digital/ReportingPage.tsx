...
import { ReportingTab } from '../digital-dashboard/tabs/ReportingTab';
import { format } from 'date-fns';
import { cn } from '@/lib/utils';

export default function DigitalReportingPage() {
                  ...
                  <div className="space-y-3">
                    ...
                    <Select value={filterReportType} onValueChange={setFilterReportType}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="campaign">Campaign Summary</SelectItem>
