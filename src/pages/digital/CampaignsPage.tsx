...
import { CampaignsTab } from '../digital-dashboard/tabs/CampaignsTab';
...
export default function DigitalCampaignsPage() {
  ...
  // Get unique clients from digital campaigns
      ...
      <div className="space-y-8 pb-8">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 backdrop-blur-xl border border-white/20 dark:border-white/10 p-4 sm:p-6 lg:p-8 shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Button
              onClick={() => navigate('/digital/campaigns/create')}
              size="lg"
            ...
            <Sheet open={showMoreFilters} onOpenChange={setShowMoreFilters}>
              ...
              <SheetContent>
                <SheetHeader>
                  ...
                  <SheetDescription>
                    Filter campaigns by date range and client
                  </SheetDescription>
                </SheetHeader>
