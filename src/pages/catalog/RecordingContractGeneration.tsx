...
export default function RecordingContractGeneration() {
  ...
  useEffect(() => {
    if (recordingDetails?.recording) {
      setContractTerms(prev => ({
        ...prev,
        title: `Master Rights Agreement - ${recordingDetails.recording.title}`
      }));
    }
  }, [recordingDetails]);
    ...
    <AppLayout>
      <div className="container mx-auto py-6 space-y-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold">Generate Recording Contract</h1>
            <p className="text-muted-foreground mt-1">
              Creating contract for: <strong>{recording.title}</strong>
            </p>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure the basic contract terms for this recording
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="e.g., Master Rights Agreement - Recording Title"
              />
            </div>
