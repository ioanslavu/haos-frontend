...
import { Calendar as CalendarIcon, RotateCcw, SlidersHorizontal, X } from 'lucide-react'
...
export const CampaignFiltersSheet = memo(function CampaignFiltersSheet({
  ...
  return (
    <>
      ...
      {/* Sidebar Panel */}
      <div className="fixed inset-y-0 right-0 z-50 w-[340px] bg-background border-l border-border shadow-2xl flex flex-col">
        {/* Header */}
