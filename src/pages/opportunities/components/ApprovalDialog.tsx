/**
 * Approval Dialog
 * Comprehensive dialog for creating and editing approvals
 */
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {isEdit
              ...
              : 'Add an approval stage for this opportunity.'
            }
          </DialogDescription>
        </DialogHeader>
                ...
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      {deliverablesList?.map((d: any) => (
                        <SelectItem key={d.id} value={d.id.toString()}>
                          {d.deliverable_type} - {d.description?.substring(0, 50) || 'No description'}
                        </SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Link to the file for approval (Google Drive, Dropbox, etc.)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
